export interface SearchGIFInterface {
    data:       Gif[];
...
export class Convert {
    public static toSearchGIFInterface(json: string): SearchGIFInterface {
        return cast(JSON.parse(json), r("SearchGIFInterface"));
    }

    public static searchGIFInterfaceToJson(value: SearchGIFInterface): string {
        return JSON.stringify(uncast(value, r("SearchGIFInterface")), null, 2);
    }
}
